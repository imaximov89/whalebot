...
class ParseSignalMessageTests(unittest.TestCase):
    ...
    def test_send_trade_configures_cross_margin_and_max_leverage_before_entry(self):
        ...
        self.assertEqual(captured[1]["path"], "/openApi/swap/v2/trade/leverage")
        self.assertEqual(captured[1]["payload"]["leverage"], "125")
        self.assertEqual(captured[1]["payload"]["side"], "LONG")
        self.assertEqual(captured[1]["payload"]["recvWindow"], "60000")
        self.assertNotIn("positionSide", captured[1]["payload"])
